...
public enum CreateUserValidator implements Validator<CreateUserDto> {
    INSTANCE;

    public static final String LOGIN_REGEX_PATTERN = "^[a-zA-Z0-9_]{3,30}$";
    public static final String PASSWORD_REGEX_PATTERN = "^[a-zA-Z0-9._-]{8,30}$";
